...
from nets.SelfAttention import ScaledDotProductAttention
from nets.SimplifiedSelfAttention import SimplifiedScaledDotProductAttention
from nets.unet_model import UNet
from nets.UNet2Plus import UNet2Plus
from nets.UNet3Plus import UNet3Plus, UNet3Plus_DeepSup, UNet3Plus_DeepSup_CGM
...
class Trainer(object):
    def __init__(self, args, backbone):
        ...
        if backbone == 'unet2plus':
           model = UNet2Plus(n_channels=3, n_classes=self.nclass)
        elif backbone == 'unet3plus':
            model = UNet3Plus(n_channels=3, n_classes=self.nclass)
        ...
        # model = AttU_Net(num_classes=2, backbone='attention_unet'
        #                           )
        #model = UNet(n_classes=2, backbone='unet',  n_channels=3
                         #)
    ...
    def validation(self, epoch):
        ...
        print('Validation:')
        print('[Epoch: %d, numImages: %5d]' % (epoch, i * self.args.batch_size + image.data.shape[0]))
        print("Acc:{}, Acc_class:{}, mIoU:{}, [] :{}, fwIoU: {}, precision: {}, f1score: {}, recall: {}, teyixing: {}, jc系数: {}".format(Acc,Acc_class,IoU, mIoU, FWIoU,precision,f1score,recall,teyixing,jcc))
...
def main():
    ...
    if args.checkname is None:
        args.checkname = 'UNet3Plus31-'+str(args.backbone)
    print(args)
